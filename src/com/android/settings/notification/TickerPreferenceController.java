...
public class TickerPreferenceController extends TogglePreferenceController
        implements LifecycleObserver, OnStart, OnStop {

    private static final String KEY = "status_bar_show_ticker";

    private PrimarySwitchPreference mPreference;
    private SettingObserver mSettingObserver;

    public TickerPreferenceController(Context context, String preferenceKey) {
    ...
    private class SettingObserver extends ContentObserver {
        private final Uri mUri = Settings.System.getUriFor(KEY);
